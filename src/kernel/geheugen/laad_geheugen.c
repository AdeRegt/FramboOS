...
void laad_geheugen(BootInfo *meme)
{
    ...
    idt_set_entry(&idt[0x00], error_interrupt_handler_0x00_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x01], error_interrupt_handler_0x01_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x02], error_interrupt_handler_0x02_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x03], error_interrupt_handler_0x03_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x04], error_interrupt_handler_0x04_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x05], error_interrupt_handler_0x05_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x06], error_interrupt_handler_0x06_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x07], error_interrupt_handler_0x07_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x08], error_interrupt_handler_0x08_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x09], error_interrupt_handler_0x09_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x0A], error_interrupt_handler_0x0A_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x0B], error_interrupt_handler_0x0B_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x0C], error_interrupt_handler_0x0C_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x0D], error_interrupt_handler_0x0D_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x0E], error_interrupt_handler_0x0E_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x0F], error_interrupt_handler_0x0F_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x10], error_interrupt_handler_0x10_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x11], error_interrupt_handler_0x11_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x12], error_interrupt_handler_0x12_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x13], error_interrupt_handler_0x13_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x14], error_interrupt_handler_0x14_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x15], error_interrupt_handler_0x15_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x16], error_interrupt_handler_0x16_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x17], error_interrupt_handler_0x17_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x18], error_interrupt_handler_0x18_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x19], error_interrupt_handler_0x19_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x1A], error_interrupt_handler_0x1A_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x1B], error_interrupt_handler_0x1B_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x1C], error_interrupt_handler_0x1C_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x1D], error_interrupt_handler_0x1D_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x1E], error_interrupt_handler_0x1E_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
    idt_set_entry(&idt[0x1F], error_interrupt_handler_0x1F_, GDT_KERNEL_CODE, 0, IDT_TYPE_INTERRUPT_GATE);
